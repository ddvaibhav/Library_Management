      ...
      <div className="footer-container">
        ...
        <div className="footer-main">
          ...
          <div className="footer-column">
            ...
            <p className="footer-about-text">
              The New Arts Commerce and Science Library serves as the academic hub of our institution,
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            &copy; {new Date().getFullYear()} New Arts Commerce and Science Library. All rights reserved.
          </div>
